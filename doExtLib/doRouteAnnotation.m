...
@implementation doRouteAnnotation
    ...
    switch (_type) {
        case 0:
        {
            ...
            if (view == nil) {
                ...
                view.image = [UIImage imageNamed:@"do_BMKMapView.bundle/icon_start.png"];
        ...
        case 1:
        {
            ...
            if (view == nil) {
                ...
                view.image = [UIImage imageNamed:@"do_BMKMapView.bundle/icon_end.png"];
                view.centerOffset = CGPointMake(0, -(view.frame.size.height * 0.5));
            }
        }
            break;
        case 2:
        {
            ...
            if (view == nil) {
                ...
                view.image = [UIImage imageNamed:@"do_BMKMapView.bundle/icon_bus.png"];
            }
        }
            break;
        case 3:
        {
            ...
            if (view == nil) {
                ...
                view.image = [UIImage imageNamed:@"do_BMKMapView.bundle/icon_rail.png"];
            }
        }
            break;
        case 4:
        {
            ...
            UIImage* image = [UIImage imageNamed:@"do_BMKMapView.bundle/icon_direction.png"];
        ...
        case 5:
        {
            ...
            UIImage* image = [UIImage imageNamed:@"do_BMKMapView.bundle/icon_waypoint.png"];
            view.image = [image imageRotatedByDegrees:_degree];
        }
            break;
        ...
        case 6:
        {
            ...
            view.image = [UIImage imageNamed:@"do_BMKMapView.bundle/icon_stairs.png"];
        }
            break;
        default:
            break;
